...
static void GPIO_Configuration(void) {
  ...
  // init SWM
  Chip_SWM_Init();
  Chip_SWM_MovablePinAssign(SWM_SPI0_SCK_IO,INDICATOR_SCLK_Pin);
  Chip_SWM_MovablePinAssign(SWM_SPI0_MOSI_IO,INDICATOR_MOSI_Pin);
...
void IndicatorDisplayDecLZ(uint8_t val) {
...
void IndicatorDisplayHexLZ(uint16_t val) {
